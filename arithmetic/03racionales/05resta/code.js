...
// y los resta, regresando el resultado en forma simplificada.
function Ejercicio01(){
    ...
    // Hace la resta y guarda el resultado en las variables globales
    var resultado = restaRacional(rat1_1,rat2_1);
    nr_1 = resultado[0];
    dr_1 = resultado[1];
}
...
// pero el primero racional debe ser positivo y se le debe restar un segundo
// racional que sea positivo. En otras palabras, se hace una operación 
// de la forma -a/b -c/b, donde a, b y c son enteros positivos y b > 1. El resultado claramente será negativo.
// Para obtener el resultado, simplemente se calcula a/b + c/b = (a+c)/b, y se pone el signo negativo al resultado.
function Ejercicio02(){
    ...
    var resultado = sumaRacional(rat1_2,rat2_2);
    nr_2 = -resultado[0];
    dr_2 = resultado[1];
}
...
// En esta ocasión, se hará la resta de un racional positivo con un racional negativo, es decir, 
// se hará una operación de la forma a/b - (-c/d) = a/b + c/d. Por tal razón,
// basta con generar los números a, b, c y d, y luego calcular la suma de los racionales. El resultado será positivo.
function Ejercicio03(){
    ...
    // Calcula la suma de los racionales, que será positiva, y luego se le pone el signo negativo al resultado
    var resultado = sumaRacional(rat1_3,rat2_3);
    nr_3 = resultado[0];
    dr_3 = resultado[1];
}
...
// En esta ocasión, se hará la resta de un racional negativo con otro racional
// negativo, es decir, se hará una operación de la forma -a/b - (-c/d) = -a/b + c/d. Por tal razón,
// basta con generar los números a, b, c y d, y luego calcular la resta de los racionales. El resultado puede ser positivo o negativo.
function Ejercicio04(){
    ...
    // Calcula la resta de los racionales, que puede ser positiva o negativa
    // Ya que el resultado será -a/b + c/b = c/b - a/b, la resta se hará en el orden c/b - a/b
    var resultado = restaRacional(rat2_4,rat1_4);
    nr_4 = resultado[0];
    dr_4 = resultado[1];
}
...
// Por tal razón, se hace la resta de los racionales de la forma a/b - c/d, donde a, b, c y d son enteros positivos y b > 1 y d > 1. 
...
function Ejercicio05(){
    ...
    // Calcula la resta de los racionales, que puede ser positiva o negativa
    var resultado = restaRacional(rat1_5,rat2_5);
    nr_5 = resultado[0];
    dr_5 = resultado[1];
}
...
function Ejercicio06(){
    ...
    // Calcula la resta de los racionales, que será negativa
    var resultado = sumaRacional(rat1_6,rat2_6);
    nr_6 = -resultado[0];
    dr_6 = resultado[1];
}
...
// Por tal razón, se hace la resta de los racionales de la forma a/b - (-c/d) = a/b + c/d, donde a, b, c y d son enteros positivos y b > 1 y d > 1. 
...
function Ejercicio07(){
    ...
    var resultado = sumaRacional(rat1_7,rat2_7);
    nr_7 = resultado[0];
    dr_7 = resultado[1];
}
...
function Ejercicio08(){
    ...
    // Calcula la resta de los racionales, que puede ser positiva o negativa
    // Ya que el resultado será -a/b + c/d, la resta se hará en el orden c/d - a/b
    var resultado = restaRacional(rat2_8,rat1_8);
    nr_8 = resultado[0];
    dr_8 = resultado[1];
}
...
// En esta ocasión, se efectúa la resta de un entero positivo con una fracción negativa, esto es,
// se hace una operación de la forma a - b/c. El entero se representará con la variable ent9
// y el numerador y el denominador de la fracción con a9 y b9. Se representa al entero
// como una fracción con denominador 1 y numerador positivo siempre
function Ejercicio09(){
    ...
    var ent9 = enteroAleatorio(1,49);

    // Debe asegurarse que que las fracciones no sean enteras, esto es, 
    // que b9 no divida a a9 
    while(a9 % b9 === 0)
    ...
    document.getElementById("ent_9").innerHTML = ent9;
    ...
    // Calcula la resta del entero y el racional, que puede ser
    // positiva o negativa
    var resultado = restaRacional(rat1_9,rat2_9);
    nr_9 = resultado[0];
    dr_9 = resultado[1];
}
...
// Es similar al Ejercicio 9, pero en esta ocasión, se efectúa la resta de un entero negativo con una fracción positiva, esto es,
// se hace una operación de la forma -a - b/c. El entero se representará con la variable ent10
// y el numerador y el denominador de la fracción con a10 y b10. Se representa al entero
// como una fracción con denominador 1 y numerador negativo siempre
function Ejercicio10(){
    ...
    var ent10 = enteroAleatorio(1,49);

    // Debe asegurarse que que las fracciones no sean enteras, esto es, 
    // que b10 no divida a a10 
    while(a10 % b10 === 0)
        a10 = enteroAleatorio(1,49);

    rat1_10 = [ent10,1]; // Los enteros siempre se representan con denominador 1 y numerador positivo
    rat2_10 = [a10,b10];

    document.getElementById("signo1_10").innerHTML = "- ";
    document.getElementById("ent_10").innerHTML = ent10;
    ...
    // Calcula la suma de la forma ent10 + a10/b10 y después simplemente le cambia el signo al numerador
    resultado = sumaRacional(rat1_10,rat2_10);
...
// Es similar al Ejercicio anterior, pero en esta ocasión se efectúa la resta de un entero positivo
// con una fracción negativa, esto es, se hace una operación de la forma ent11 - (-a11/b11) = ent11 + a11/b11. El entero se representará con la variable ent11
// y el numerador y el denominador de la fracción con a11 y b11. Se representa al entero
// como una fracción con denominador 1 y numerador positivo siempre
function Ejercicio11(){
    ...
    var ent11 = enteroAleatorio(1,49);

    // Debe asegurarse que que las fracciones no sean enteras, esto es, 
    // que b11 no divida a a11 
    while(a11 % b11 === 0)
    ...
    document.getElementById("ent_11").innerHTML = ent11;
    ...
    // Al ser la segunda fracción negativa, se debe poner un paréntesis izquierdo (lp1_11) y un paréntesis derecho (rp1_11) para que se vea bien el ejercicio en la página
    document.getElementById("lp1_11").innerHTML = "(";
    document.getElementById("rp1_11").innerHTML = ")";

    // Calcula la suma de la forma ent11 + a11/b11
    var resultado = sumaRacional(rat1_11,rat2_11);
    nr_11 = resultado[0];
    dr_11 = resultado[1];
}
...
// Es similar al Ejercicio anterior, pero en esta ocasión se efectúa la resta de un entero negativo
// con una fracción negativa, esto es, se hace una operación de la forma -ent12 - (- a12/b12) = -ent12 + a12/b12.
// El entero se representará con la variable ent12 y el numerador y el denominador de la fracción con a12 y b12. Se representa al entero
// como una fracción con denominador 1 y numerador positivo siempre
function Ejercicio12(){
    ...
    var ent12 = enteroAleatorio(1,49);

    // Debe asegurarse que que las fracciones no sean enteras, esto es, 
    // que b12 no divida a a12 
    while(a12 % b12 === 0)
    ...
    document.getElementById("ent_12").innerHTML = ent12;
    ...
    // Al ser la segunda fracción negativa, se debe poner un paréntesis izquierdo (lp1_12) y un paréntesis derecho (rp1_12) para que se vea bien el ejercicio en la página
    document.getElementById("lp1_12").innerHTML = "(";
    document.getElementById("rp1_12").innerHTML = ")";

    // Calcula la resta de la forma -ent12 + a12/b12, que puede ser positiva o negativa. Para ello,
    // utiliza la función restaRacional, pero invierte el orden de los racionales, ya que la función restaRacional hace la resta del primer racional menos el segundo racional.
    var resultado = restaRacional(rat2_12,rat1_12);
    nr_12 = resultado[0];
    dr_12 = resultado[1];
}
