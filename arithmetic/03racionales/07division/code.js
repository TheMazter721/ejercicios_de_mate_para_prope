...
same_num: Puede ser 1 o 0. Es 1 si se requiere que ambos numeradores sean iguales
...
*/
function Ejercicio(n, same_den, same_num, neg1, neg2, ent1, ent2){
    ...
    if(ent1+ent2==0){    // Ahora, genera la primera fracción
        ...
        // Si se solicita el mismo numerador, simplemente pone c = a,
        // y genera el denominador
        else if(same_num == 1){
            var c = a;
        ...
        // Independientemente de los signos, puede obtener un resultado parcial haciendo la división
        var rat1 = [a, b];
        var rat2 = [c, d];

        var resultado = divideRacional(rat1, rat2);
    ...
    // Si se pidió que la segunda fracción fuera un entero, entonces solo hay que generar lo de la primera fracción
    else{
        // Genera un entero aleatorio entre 1 y 12
    ...
    // Sinalmente, deve hacer visible el contenedor del ejercicio, pues ya tiene todos los datos necesarios
    document.getElementById("contenedor-ejercicio-" + n).style.display = "block";
}
