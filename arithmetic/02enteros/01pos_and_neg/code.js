...
// debe determinar si es positivo, negativo o cero. En este caso, como el número es positivo, 
// la respuesta siempre será "Positivo". Sin embargo, el ejercicio se puede modificar para generar números negativos o incluso cero, 
...
function Respuesta01(){
    ...
    if(typeof n_1 === 'undefined')
        return;
    document.getElementById("r_1").innerHTML = n_1 > 0 ? "Positivo" : (n_1 < 0 ? "Negativo" : "Cero");
}

// Ejercicio 2: 
// Es similar al ejercicio 1, pero en esta ocasión se utilizan 
// números positivos de dos dígitos. La respuesta seguirá siendo "Positivo" para todos los casos, pero se puede modificar 
// el ejercicio para incluir números negativos o cero, lo que haría que la respuesta pueda ser "Negativo" o "Cero" respectivamente.
...
function Respuesta02(){
    ...
    if(typeof n_2 === 'undefined')
        return;
    document.getElementById("r_2").innerHTML = n_2 > 0 ? "Positivo" : (n_2 < 0 ? "Negativo" : "Cero");
}
...
function Respuesta03(){
    ...
    if(typeof n_3 === 'undefined')
        return;
    document.getElementById("r_3").innerHTML = n_3 > 0 ? "Positivo" : (n_3 < 0 ? "Negativo" : "Cero");
}
...
function Respuesta04(){
    ...
    if(typeof n_4 === 'undefined')
        return;
    document.getElementById("r_4").innerHTML = n_4 > 0 ? "Positivo" : (n_4 < 0 ? "Negativo" : "Cero");
}
...
function Respuesta05(){
    ...
    if(typeof n_5 === 'undefined')
        return;
    document.getElementById("r_5").innerHTML = n_5 > 0 ? "Positivo" : (n_5 < 0 ? "Negativo" : "Cero");
}
...
function Respuesta06(){
    ...
    if(typeof n_6 === 'undefined')
        return;
    document.getElementById("r_6").innerHTML = n_6 > 0 ? "Positivo" : (n_6 < 0 ? "Negativo" : "Cero");
}
...
function Respuesta07(){
    ...
    if(typeof n_7 === 'undefined')
        return;
    document.getElementById("r_7").innerHTML = n_7 > 0 ? "Positivo" : (n_7 < 0 ? "Negativo" : "Cero");
}
...
function Respuesta08(){
    ...
    if(typeof n_8 === 'undefined')
        return;
    document.getElementById("r_8").innerHTML = n_8 > 0 ? "Positivo" : (n_8 < 0 ? "Negativo" : "Cero");
}
...
function Respuesta09(){
    ...
    if(typeof n_9 === 'undefined')
        return;
    document.getElementById("r_9").innerHTML = n_9 > 0 ? "Positivo" : (n_9 < 0 ? "Negativo" : "Cero");
}
...
function Respuesta10(){
    ...
    if(typeof n_10 === 'undefined')
        return;
    document.getElementById("r_10").innerHTML = n_10 > 0 ? "Positivo" : (n_10 < 0 ? "Negativo" : "Cero");
}
...
function Respuesta11(){
    ...
    if(typeof n_11 === 'undefined')
        return;
    document.getElementById("r_11").innerHTML = n_11 > 0 ? "Positivo" : (n_11 < 0 ? "Negativo" : "Cero");
}
...
function Respuesta12(){
    ...
    if(typeof n_12 === 'undefined')
        return;
    document.getElementById("r_12").innerHTML = n_12 > 0 ? "Positivo" : (n_12 < 0 ? "Negativo" : "Cero");
}